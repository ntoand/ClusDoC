...
%%                                                
                ...
                % Colocalisation and Density map per C   
                    ...
                    tt = getframe(gcf);
                    imwrite(tt.cdata, fullfile(Path_name, f1, 'Density and PoC maps', sprintf('%sDensity_Ch%d.tif', GenericName, 1)));
                    if(settings.AlsoSaveFig)
                        saveas(gcf, fullfile(Path_name, f1, 'Density and PoC maps', sprintf('%sDensity_Ch%d.fig', GenericName, 1)));
                    end
                    ...
                    tt = getframe(gcf);
                    imwrite(tt.cdata, fullfile(Path_name, f1, 'Density and PoC maps', sprintf('%sDensity_Ch%d.tif', GenericName, 2)));
                    if(settings.AlsoSaveFig)
                        saveas(gcf, fullfile(Path_name, f1, 'Density and PoC maps', sprintf('%sDensity_Ch%d.fig', GenericName, 2)));
                    end
                    %saveas(gcf,strcat('Plot6\',GenericName ,'Plot6',strcat('_Ch',num2str(i))), 'tif');
                    close gcf
                    ...
                    tt = getframe(gcf);
                    imwrite(tt.cdata, fullfile(Path_name, f1, 'Density and PoC maps', sprintf('%sPoC_Ch%d.tif', GenericName, 1)));
                    if(settings.AlsoSaveFig)
                        saveas(gcf, fullfile(Path_name, f1, 'Density and PoC maps', sprintf('%sDoC_Ch%d.fig', GenericName, 1)));
                    end
                    %saveas(gcf,strcat('Plot6\',GenericName ,'Plot6',strcat('_Ch',num2str(i))), 'tif');
                    close gcf
                    ...
                    tt = getframe(gcf);
                    imwrite(tt.cdata, fullfile(Path_name, f1, 'Density and PoC maps', sprintf('%sPoC_Ch%d_log.tif', GenericName, 1)));
                    if(settings.AlsoSaveFig)
                        saveas(gcf, fullfile(Path_name, f1, 'Density and PoC maps', sprintf('%sPoC_Ch%d_log.fig', GenericName, 1)));
                    end
                    %saveas(gcf,strcat('Plot6\',GenericName ,'Plot6',strcat('_Ch',num2str(i))), 'tif');
                    close gcf
